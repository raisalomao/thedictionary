...
class BasicInformations:
    ...
    def Portuguese(palavra = str):
        ...
        animation = Animations.analogic_sinonimos(name.lower(), sinonimos[:10])
        if animation:
            return DICTIONARY(name, response, syllables, partofspeech, meanings, etymology, sinonimos, antonyms), animation
